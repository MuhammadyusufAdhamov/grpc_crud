...
type UserCrudClient interface {
	...
	Get(ctx context.Context, in *IdUser, opts ...grpc.CallOption) (*UserResponse, error)
...
func (c *userCrudClient) Create(ctx context.Context, in *User, opts ...grpc.CallOption) (*UserResponse, error) {
...
func (c *userCrudClient) Get(ctx context.Context, in *IdUser, opts ...grpc.CallOption) (*UserResponse, error) {
	out := new(UserResponse)
...
func (c *userCrudClient) Update(ctx context.Context, in *User, opts ...grpc.CallOption) (*UserResponse, error) {
	out := new(UserResponse)
...
type UserCrudServer interface {
	...
	Get(context.Context, *IdUser) (*UserResponse, error)
...
func (UnimplementedUserCrudServer) Create(context.Context, *User) (*UserResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Create not implemented")
}
func (UnimplementedUserCrudServer) Get(context.Context, *IdUser) (*UserResponse, error) {
...
func (UnimplementedUserCrudServer) Update(context.Context, *User) (*UserResponse, error) {
